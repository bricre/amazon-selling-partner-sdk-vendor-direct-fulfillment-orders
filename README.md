# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Direct Fulfillment Orders
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-direct-fulfillment-orders
```
...
```php
<?php
use Amz\VendorDirectFulfillmentOrders\ResponseTypes;
